          ...
          <div className="max-w-2xl xl:max-w-3xl">
            ...
            <div className="hero-cta flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="inline-flex items-center justify-center gap-3 bg-primary text-white font-semibold text-base px-7 py-4 rounded-full cta-primary shadow-lg"
              >
          ...
          <div className="card-grid grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            ...
            <article className="card-item rounded-2xl overflow-hidden bg-light-blue p-6 md:col-span-2 lg:col-span-1">
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Agendar cita por WhatsApp"
                className="inline-flex items-center gap-2 bg-primary text-white text-sm font-semibold px-5 py-3 rounded-full mt-6 cta-primary"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div data-reveal>
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Agendar cita por WhatsApp"
                className="inline-flex items-center gap-3 bg-primary text-white font-semibold px-7 py-4 rounded-full cta-primary"
              >
      ...
      >
        <div className="max-w-4xl mx-auto px-5 lg:px-8">
          ...
          <div className="text-center mt-10" data-reveal-fast>
            <p className="text-muted text-sm mb-5">¿Tiene otra pregunta? Contáctenos directamente.</p>
            <a
              href={WA_URL}
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-5 lg:px-8 text-center" data-reveal>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              rel="noopener noreferrer"
              aria-label="Agendar cita por WhatsApp"
              className="inline-flex items-center justify-center gap-3 bg-white text-navy font-bold text-base px-8 py-4 rounded-full cta-primary shadow-xl"
            >
